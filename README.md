...
After dumping the MySQL installation will be removed again and installed securely. After importing the dump, the `mysql_secure_installation` will run which requires input from you. This is to ensure a secure installation without corrupted database files. 
